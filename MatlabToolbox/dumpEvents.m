...
% Currently the file is ~/Desktop/MatlabOutput.txt, which is appended every time a new set of events is 
% passed to Matlab.  The time of each event is given in milliseconds.  If an event with the tag 'trialStart'
