...
cp -rf /Applications/MWServer.app $APPS_INSTALL_DIR
...
cp -rf /Library/Frameworks/Narrative.framework $FRAMEWORK_INSTALL_DIR
...
rm -rf $RESOURCES_INSTALL_DIR/Plugins/DLabTemplatePlugin.bundle
...
#mkdir -p $APP_SUPPORT_INSTALL_DIR/Plugins
#cp -rf /Library/Application\ Support/NewClient/Plugins/CalibratorWindow.bundle  $APP_SUPPORT_INSTALL_DIR/Plugins
#cp -rf /Library/Application\ Support/NewClient/Plugins/MonkeyWorksBehavioralWindow.bundle  $APP_SUPPORT_INSTALL_DIR/Plugins
#cp -rf /Library/Application\ Support/NewClient/Plugins/MonkeyWorksEyeWindow.bundle  $APP_SUPPORT_INSTALL_DIR/Plugins
#cp -rf /Library/Application\ Support/NewClient/Plugins/MonkeyWorksMATLABWindow.bundle  $APP_SUPPORT_INSTALL_DIR/Plugins
#cp -rf /Library/Application\ Support/NewClient/Plugins/MonkeyWorksRewardWindow.bundle  $APP_SUPPORT_INSTALL_DIR/Plugins
#cp -rf /Library/Application\ Support/NewClient/Plugins/MonkeyWorksVariablesWindow.bundle $APP_SUPPORT_INSTALL_DIR/Plugins
cp -rf /Library/Application\ Support/NewClient $APP_SUPPORT_INSTALL_DIR

# these shouldn't be included in the installer.
rm -rf $APP_SUPPORT_INSTALL_DIR/NewClient/Plugins/DLabTemplateClientWindow.bundle
rm -rf $APP_SUPPORT_INSTALL_DIR/NewClient/Plugins/RatBehaviorWindow.bundle
