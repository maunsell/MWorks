...
shared_ptr<mComponent> mFakeMonkeyFixateFactory::createObject(std::map<std::string, std::string> parameters,
	...
	shared_ptr <mComponent> new_fixate_action = shared_ptr<mComponent>(new mFakeMonkeyFixate(fm,
																							 duration));
